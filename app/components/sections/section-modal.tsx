...
interface SectionModalProps {
  ...
  mode: 'create' | 'edit';
  sectionData?: { id: string; name: string; description?: string | null };
  classId?: string;
}
...
export default function SectionModal({
  ...
  }, [isOpen, mode, sectionData, setValue, reset]);

  if (!isOpen) return null;

  const onFormSubmit = async (data: SectionForm) => {
          ...
          <form onSubmit={handleSubmit(onFormSubmit)} className="space-y-5">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-gray-900 bg-white resize-none"
              />
            </div>
